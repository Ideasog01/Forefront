...
public class InputManager : MonoBehaviour
{
    ...
    private void InitialiseInput()
    {
        ...
        customInput.XRIRightHandInteraction.Select.started += ctx => GameManager.controllerManager.EnableShield(true);
        customInput.XRIRightHandInteraction.Select.canceled += ctx => GameManager.controllerManager.EnableShield(false);
